...
public class buildTree_07 {
    ...
    private TreeNode buildTree(int[] preorder,int pleft,int pright,int[] inorder,int ileft,int irighht){
        if(pleft>pright||ileft>irighht)
            return null;
        // 根结点
        ...
        node.right = buildTree(preorder,pleft+leftLen+1,pright,inorder,index+1,irighht);
        return node;
